...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [911198.050494, 6232717.107916, 913638.567160, 6234416.791249], maxZoom: 23, minZoom: 8, projection: new ol.proj.Projection({
            code: 'EPSG:2154',
            //extent: [911762.191215, 6232805.531020, 913029.827087, 6234349.735278],
            units: 'm'})
    })
});

//initial view - epsg:3857 coordinates if not "Match project CRS"
map.getView().fit([911198.050494, 6232717.107916, 913638.567160, 6234416.791249], map.getSize());
